                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                $status = $absensiData[$siswa->id]->status ?? 'alpha';
                                $waktu = $absensiData[$siswa->id]->created_at ?? null;
                            @endphp
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-between px-3">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="a_{{ $siswa->id }}" name="absensi[{{ $siswa->id }}]" 
                                                   class="custom-control-input radio-alpha" value="alpha" 
                                                   {{ $status == 'alpha' ? 'checked' : '' }}>
                                            <label class="custom-control-label text-danger" for="a_{{ $siswa->id }}">Alpha</label>
                                        </div>
                                    </div>
                                </td>
